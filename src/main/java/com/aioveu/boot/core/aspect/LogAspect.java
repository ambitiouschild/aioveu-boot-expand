package com.aioveu.boot.core.aspect;
...
import com.aioveu.boot.common.util.IPUtils;
import com.aioveu.boot.core.security.util.SecurityUtils;
import com.aioveu.boot.system.model.entity.Log;
...
public class LogAspect {
     ...
     * 切点
     */
    @Pointcut("@annotation(com.aioveu.boot.common.annotation.Log)")
    ...
    public Object doAround(ProceedingJoinPoint joinPoint, com.aioveu.boot.common.annotation.Log logAnnotation) throws Throwable {
     ...
     * @param userId        用户ID
     */
    private void saveLog(final JoinPoint joinPoint, final Exception e, Object jsonResult, com.aioveu.boot.common.annotation.Log logAnnotation, long executionTime, Long userId) {
