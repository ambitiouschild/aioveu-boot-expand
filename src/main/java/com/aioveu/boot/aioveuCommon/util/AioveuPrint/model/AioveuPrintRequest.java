...
public class AioveuPrintRequest {
    ...
    private AioveuPrintType printType; // 打印类型    QR_CODE  RECEIPT   CARE_LABEL


    @Schema(description = "订单No（用于小票打印）")
    private String orderNo; // 订单ID（用于小票打印）
    ...
    private String template; // 打印模板   标准模板 "standard"  标签模板 "label"  简约模板 "simple"  简约模板 "simple"  receipt  care_label
    ...
    private Boolean showInfo;       // 是否显示衣物信息 // 是否显示额外信息
